...
export const InputGroupWrapper = ({
  ...
  <label className={`text-theme-text-main text-base font-medium ${className}`}>
    {label}
    {children}
  </label>
);
...
export const INPUT_CLASS_NAME =
  'mt-1 px-3 py-2 block w-full rounded-md border border-theme-base bg-theme-base text-theme-text-main shadow-sm outline-none font-normal text-base focus:border-primary';
