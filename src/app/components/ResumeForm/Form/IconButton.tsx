...
export const MoveIconButton = ({
  ...
  return (
    <IconButton onClick={() => onClick(type)} tooltipText={tooltipText} size={size}>
      <Icon className={`${sizeClassName} text-theme-text-muted`} aria-hidden="true" />
      <span className="sr-only">{tooltipText}</span>
    </IconButton>
  );
};
...
export const DeleteIconButton = ({
  ...
  return (
    <IconButton onClick={onClick} tooltipText={tooltipText} size="small">
      <TrashIcon className="text-theme-text-muted h-4 w-4" aria-hidden="true" />
      <span className="sr-only">{tooltipText}</span>
    </IconButton>
  );
};
...
export const BulletListIconButton = ({
  ...
  return (
    ...
    >
      <ListBulletIcon
        className={`h-4 w-4 ${showBulletPoints ? 'text-theme-text-main' : 'text-theme-text-muted'}`}
        aria-hidden="true"
      />
      <span className="sr-only">{tooltipText}</span>
    </IconButton>
