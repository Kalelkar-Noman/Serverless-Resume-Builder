...
const Selection = ({
  ...
  return (
    <div
      className="border-theme-base bg-theme-card text-theme-text-muted hover:text-theme-text-main flex w-[105px] cursor-pointer items-center justify-center rounded-md border py-1.5 shadow-sm hover:border-primary"
      onClick={onClick}
  ...
  return (
    <SelectionsWrapper>
      {allFontFamilies.map((fontFamily, idx) => {
        ...
        const standardSizePt = FONT_FAMILY_TO_STANDARD_SIZE_IN_PT[fontFamily as FontFamily] || 11;
        return (
          <Selection
            key={idx}
          ...
          >
            {FONT_FAMILY_TO_DISPLAY_NAME[fontFamily as FontFamily] || fontFamily}
          </Selection>
        );
      })}
    </SelectionsWrapper>
