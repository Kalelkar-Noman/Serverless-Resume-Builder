...
import { initialSettings, setSettings, type Settings } from 'lib/redux/settingsSlice';
 ...
 * Uses a 1-second debounce to prevent writing to disk on every single keystroke,
 * which significantly improves UI performance.
 */
